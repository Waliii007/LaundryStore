...
namespace Invector.vCharacterController
{
    public class vThirdPersonController : vThirdPersonAnimator
    {
        private void Awake()
        {
            ReferenceManager.OnPLayerGotUpgrade += ChangeSpeed;
        }
        ...
        {
            MySpeed speed = (MySpeed)ReferenceManager.Instance.GameData.playerMovingSpeed;
            switch (speed)
            {
                case MySpeed.SLow:
                    ...
                    break;
                case MySpeed.Medium:
                    freeSpeed.walkSpeed = 3;
                    freeSpeed.runningSpeed = 4;
                    break;
                case MySpeed.High:
                    freeSpeed.walkSpeed = 4;
                    freeSpeed.runningSpeed = 6;
                    break;
            }
        }
